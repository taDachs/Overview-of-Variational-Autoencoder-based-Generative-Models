...
Future work could focus the evaluation of the disentanglement. One method already proposed uses trained linear classifiers \cite{higgins2017vae}. Another method uses a metric based on \textit{mutual information} \cite{chen2019isolating}. With a better disentanglement metric than visual inspection by a human, it would be easier to compare different models and hyperparameters with each other.
